...
echo "Start packaging for $PLATFORM $ARCH."
 ...
 APP_NAME="Net-music-cloud-uploader"
...
if [ $PLATFORM = "darwin" ]; then
    ditto -rsrcFork ./dist/Electronic\ CloudUploader-darwin-x64/Electronic\ WeChat.app /Applications/Electronic\ WeChat.app
    echo "$(tput setaf 3)App copied to /Applications. You can open Net-music-cloud-uploader there or from Spotlight.$(tput sgr0)"
fi